...
public class MypageDaoImpl implements MypageDao {
	...
	//DB연결 (xml에서 만들어진 객체를 가져다 사용하고자함 = 의존 주입)
		...
		public void insertMember(MemberDto dto) {
			System.out.println("#####");
			sqlSession.insert(namespace+".insertMember", dto); //괄호안은 (쿼리구문, 매개변수)순으로 입력하기
		}
		...
		public MemberDto readMember(String userid) throws Exception {
			...
			MemberDto vo = sqlSession.selectOne(namespace+".readMember", userid); //괄호안의 물음표를 콤마뒤에 쓰는거임
			return vo;
		}
		...
		@Override
		public void updateMember(MemberDto vo) throws Exception {
			sqlSession.update(namespace+".updateMember", vo);		
		}

		//회원탈퇴
		@Override
		public void deleteMember(MemberDto vo) throws Exception {
