...
public class Resume_UniversityVo {
	...
	public Resume_UniversityVo() {
		super();
	}
	
	public Resume_UniversityVo(int universityseq, int resumeseq, String university, String univ_status, String univ_str,
			String univ_str_status, String univ_end, String univ_end_status, String univ_major_field, String univ_major,
			String univ_night, String univ_grade, String univ_grade_base, String univ_paper) {
		super();
	...
	public String toString() {
		return "Resume_UniversityVo [universityseq=" + universityseq + ", resumeseq=" + resumeseq + ", university="
				+ university + ", univ_status=" + univ_status + ", univ_str=" + univ_str + ", univ_str_status="
				+ univ_str_status + ", univ_end=" + univ_end + ", univ_end_status=" + univ_end_status
				+ ", univ_major_field=" + univ_major_field + ", univ_major=" + univ_major + ", univ_night=" + univ_night
				+ ", univ_grade=" + univ_grade + ", univ_grade_base=" + univ_grade_base + ", univ_paper=" + univ_paper
				+ "]";
	}
