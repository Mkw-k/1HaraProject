...
public class Resume_LicenseDto implements Serializable {
	...
	private List<Resume_LicenseDto> list;
	...
	public String toString() {
		return "Resume_LicenseDto [licseq=" + licseq + ", resumeseq=" + resumeseq + ", lic_type="
				+ Arrays.toString(lic_type) + ", lic_date=" + Arrays.toString(lic_date) + ", lic_name="
				+ Arrays.toString(lic_name) + ", lic_publisher=" + Arrays.toString(lic_publisher) + ", lic_pass="
				+ Arrays.toString(lic_pass) + "]";
	}
