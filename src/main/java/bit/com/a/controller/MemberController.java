...
public class MemberController {
	...
	/*
	 * //로깅을 위한 변수 private static final Logger logger=
	...
	// mailSending 코드
	/*
	 * @RequestMapping( value = "auth.do" , method=RequestMethod.POST ) public
	 * ModelAndView mailSending(HttpServletRequest request, String e_mail,
	 ...
	 * 지정한다. mv.setViewName("/login/email_injeung"); //뷰의이름 mv.addObject("dice",
	 * dice);
	 * 
	 ...
	 * //이메일 인증 페이지 맵핑 메소드
	 * 
	 * @RequestMapping("email.do") public String email() { return
	 * "login/memberRegi"; }
	 * 
	 * 
	 ...
	 * public ModelAndView join_injeung(String email_injeung, @PathVariable String
	 * dice, HttpServletResponse response_equals) throws IOException {
	 * 
	 * 
	 * 
	 * 
