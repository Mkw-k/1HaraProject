define([
    ...
    Common.prototype = {
        ...
        getUpperCodes: function (lastCode, upperCd) {
            if (!Util.Lang.isEmpty(_self.searchUpperCodes[lastCode])) {
                if (upperCd === 'bcode') {
                    return _self.searchUpperCodes[lastCode].bcode;
                } else if (upperCd === 'mcode') {
                    return _self.searchUpperCodes[lastCode].mcode;
                }
            }
        },
        ...
        search: function() {
            ...
            if (typeof state.cat_key === 'undefined' && typeof state.cat_cd === 'undefined' && initialParams.cat_bcd) {
                _.set(state, 'cat_bcd', initialParams.cat_bcd);
            }
