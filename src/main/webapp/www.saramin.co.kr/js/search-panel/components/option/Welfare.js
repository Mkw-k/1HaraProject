        ...
        toggleLayer: function() {
            if (_self.$layer.is(':visible')) {
                ...
                Util.Layer.show(_self.$layer, function() {
                    if (Common.getParam('action') === 'samsung' || Common.getParam('action') === 'sba-seoul' || Common.getParam('action') === 'tech' || Common.getParam('action') === 'wiset' || Common.getParam('action') === 'youthstay' || Common.getParam('action') === 'cjpi') {
