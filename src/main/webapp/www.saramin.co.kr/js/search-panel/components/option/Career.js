    ...
    Career.prototype = {
        ...
        initParams: function () {
            ...
            if (Common.getParam('isSectionHome')
                || ((Common.getParam('action') === 'job-category' || Common.getParam('action') === 'samsung' || Common.getParam('action') === 'sba-seoul' || Common.getParam('action') === 'tech' || Common.getParam('action') === 'wiest' || Common.getParam('action') === 'youthstay' || Common.getParam('action') === 'cjpi' || Common.getParam('action') === 'dispatch' || Common.getParam('action') === 'highschool') && Common.getParam('cat_bcd') !== null && Common.getParam('cat_cd') === null)
