define([
    ...
    AutoComplete.prototype = {
        ...
        initCallback: function() {
            ...
            _.forEach(['bindEvents', 'search.generate', 'search.post', 'select'], init.bind(this));
        ...
        input: function(keyword) {
            var isAvaliableSearch = this.isAvaliableSearch(keyword);

            if (!isAvaliableSearch && this.isCommon) {
                this.callback.main.call(this);
                return true;
            }
