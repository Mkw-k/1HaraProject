...
<img src="자료실배경.png"/>
         ...
         <div id="navbar-example" style="display: list-item;">
            ...
            <ul class="nav nav-tabs" role="tablist">
               ...
               <li class="nav-item" style="margin-left: 550px;">
                  <div style="text-align: center;">
                     <a href="writeResume.do" class="box-btn" style="background-color: #a3a3a3;margin-left: 250px;">이력서 추가</a>
                  </div>
               </li>
            ...
            <div class="tab-content" style="height: 700px;">
               <div class="tab-pane fade in active" id="completed" name="completed" role="tabpanel" style="width: 900px;">
                  <div class="bs-callout bs-callout-primary" style="width: 976.25px;padding-left: -500;margin-left: 0px;">
               ...
               <div class="tab-pane fade" id="writing" role="tabpanel">
                  <div class="bs-callout bs-callout-primary" id="certifications"
                     name="certifications" style="width: 976.25px;padding-left: -500;margin-left: 0px;">
                     <ul class="list-group" style="margin-left: 0px;">
               ...
               <div class="tab-pane fade" id="portfolio" role="tabpanel">
                  <div class="bs-callout bs-callout-primary" id="certifications"
                     name="certifications" style="width: 976.25px;">
                  <ul class="list-group">
               ...
               <div class="tab-pane fade" id="applied" name="applied"
                  role="tabpanel">
                  <div class="bs-callout bs-callout-primary" style="width: 976.25px;">
                     <table class="table" style="width: 800px;text-align: center;margin-left: 0px;">
                     
                     <colgroup style="width: 500px;">
                     <col width="200px"><col width="100px"><col width="200px"><col width="150px"><col width="200px"><col width="100px">
                     </colgroup>
