																	...
																	<div class="area_period">
																		...
																		<% if( highdto.getHigh_end_status().equals("재학중") ){ %>
																				<select class="selectpicker" name="high_end_status" id="high_end_status"
																					...
																					<option value="재학중" selected="selected">재학중</option>
																					<option value="휴학중">휴학중</option>
																					<option value="수료">수료</option>
																					<option value="중퇴">중퇴</option>
																					<option value="자퇴">자퇴</option>
																		...
																		<% if( highdto.getHigh_end_status().equals("휴학중") ){ %>
																				<select class="selectpicker" name="high_end_status" id="high_end_status"
																					...
																					<option value="졸업">졸업</option>
																					<option value="재학중">재학중</option>
																					<option value="휴학중" selected="selected">휴학중</option>
																					<option value="수료">수료</option>
																					<option value="중퇴">중퇴</option>
																					<option value="자퇴">자퇴</option>
																					<option value="졸업예정">졸업예정</option>
																		...
																		<% if( highdto.getHigh_end_status().equals("자퇴") ){ %>
																				<select class="selectpicker" name="high_end_status" id="high_end_status"
																					...
																					<option value="수료">수료</option>
																					<option value="중퇴">중퇴</option>
																					<option value="자퇴" selected="selected">자퇴</option>
																					<option value="졸업예정">졸업예정</option>
																				</select>
																		<%} %>
															...
															<div id="tpl_row_1621990778" class="tpl_row"
																...
																<% if( unilist.get(i).getUniv_status().equals("대학(2,3년)")){ %>
																		<select class="selectpicker"
																			...
																			<option value="대학(2,3년)" selected="selected">대학(2,3년)</option>
																			<option value="대학원(석사)">대학원(석사)</option>
																			<option value="대학원(박사)">대학원(박사)</option>
																		</select>
																<% } %>	
																	...
																	<div class="area_grades">
																		...
																		<% if( unilist.get(i).getUniv_grade_base().equals("4.0")){ %>
																			<select class="selectpicker"
																				style="width: 107.22222px; height: 50.22222px;" name="univ_grade_base" id="univ_grade_base">
																				<option>4.5</option>
																				<option selected="selected">4.0</option>
																				<option>4.3</option>
																				<option>5.0</option>
																				<option>7.0</option>
																				<option>100</option>
																		...
																		<% if( unilist.get(i).getUniv_grade_base().equals("4.3")){ %>
																			<select class="selectpicker"
																				...
																				<option>4.5</option>
																				<option>4.0</option>
																				<option selected="selected">4.3</option>
																				<option>5.0</option>
																				<option>7.0</option>
																				<option>100</option>
																			</select>
																		...
																		<% if( unilist.get(i).getUniv_grade_base().equals("5.0")){ %>
																			<select class="selectpicker"
																				...
																				<option>4.0</option>
																				<option>4.3</option>
																				<option selected="selected">5.0</option>
																				<option>7.0</option>
																				<option>100</option>
																			</select>
																		<% } %>
																		<% if( unilist.get(i).getUniv_grade_base().equals("7.0")){ %>
																			<select class="selectpicker"
																				...
																				<option>4.3</option>
																				<option>5.0</option>
																				<option selected="selected">7.0</option>
																				<option>100</option>
																			</select>
																		<% } %>
												...
												<div id="career" class="resume_section blind_guide">
													...
													<div class="resume_write resume_career">
														<div class="select_title">
															...
															<div id="career_template" style="display: ">
																...
																<div id="tpl_row_1621990779" class="tpl_row"
																	...
																	<div class="resume_row">
																		...
																		<div class="area_period">
																			...
																			<% if(calist.get(i).getPre_status().equals("퇴사")){ %>
																				<select class="selectpicker"
																			...
																			<% } %>
																			<% if(calist.get(i).getPre_status().equals("재직중")){ %>
																				<select class="selectpicker"
																					style="width: 107.22222px; height: 50.22222px;" name="pre_status">
																	...
																	<div class="resume_row">
																		...
																		<div class="resume_bundle">
																			...
																			<% if(calist.get(i).getPre_reason().equals("업직종 전환")){ %>
																				<select class="selectpicker"
																					style="width: 107.22222px; height: 50.22222px;" name="pre_reason" id="pre_reason">
																					<option selected="selected">업직종 전환</option>
																					<option>근무조건</option>
																					<option>경영악화</option>
																					<option>계약만료</option>
																					<option>출산/육아</option>
																			...
																			<% } %>
																			<% if(calist.get(i).getPre_reason().equals("근무조건")){ %>
																				<select class="selectpicker"
																					style="width: 107.22222px; height: 50.22222px;" name="pre_reason" id="pre_reason">
																					<option>업직종 전환</option>
																					<option selected="selected">근무조건</option>
																					<option>경영악화</option>
																					<option>계약만료</option>
																					<option>출산/육아</option>
																					<option>학업</option>
																			...
																			<% } %>
																			<% if(calist.get(i).getPre_reason().equals("경영악화")){ %>
																				<select class="selectpicker"
																					style="width: 107.22222px; height: 50.22222px;" name="pre_reason" id="pre_reason">
																					<option>업직종 전환</option>
																					<option>근무조건</option>
																					<option selected="selected">경영악화</option>
																					<option>계약만료</option>
																					<option>출산/육아</option>
																					<option>학업</option>
																					<option>유학</option>
																			...
																			<% } %>
																			<% if(calist.get(i).getPre_reason().equals("계약만료")){ %>
																				<select class="selectpicker"
																					style="width: 107.22222px; height: 50.22222px;" name="pre_reason" id="pre_reason">
																					<option>업직종 전환</option>
																					<option>근무조건</option>
																					<option>경영악화</option>
																					<option selected="selected">계약만료</option>
																					<option>출산/육아</option>
																					<option>학업</option>
																					<option>유학</option>
																					<option>개인사정</option>
																			...
																			<% } %>
																			<% if(calist.get(i).getPre_reason().equals("출산/육아")){ %>
																				<select class="selectpicker"
																					style="width: 107.22222px; height: 50.22222px;" name="pre_reason" id="pre_reason">
																					<option>업직종 전환</option>
																					<option>근무조건</option>
																					<option>경영악화</option>
																					<option>계약만료</option>
																					<option selected="selected">출산/육아</option>
																					<option>학업</option>
																					<option>유학</option>
																					<option>개인사정</option>
																					<option>기타</option>
																			...
																			<% } %>
																			<% if(calist.get(i).getPre_reason().equals("학업")){ %>
																				<select class="selectpicker"
																					style="width: 107.22222px; height: 50.22222px;" name="pre_reason" id="pre_reason">
																					<option>업직종 전환</option>
																					<option>근무조건</option>
																					...
																					<option>계약만료</option>
																					<option>출산/육아</option>
																					<option selected="selected">학업</option>
																					<option>유학</option>
																					<option>개인사정</option>
																					<option>기타</option>
																				</select>
																			<% } %>
																			<% if(calist.get(i).getPre_reason().equals("유학")){ %>
																				<select class="selectpicker"
																					style="width: 107.22222px; height: 50.22222px;" name="pre_reason" id="pre_reason">
																					<option>업직종 전환</option>
																					<option>근무조건</option>
																					...
																					<option>출산/육아</option>
																					<option>학업</option>
																					<option selected="selected">유학</option>
																					<option>개인사정</option>
																					<option>기타</option>
																				</select>
																			<% } %>
																			<% if(calist.get(i).getPre_reason().equals("개인사정")){ %>
																				<select class="selectpicker"
																					style="width: 107.22222px; height: 50.22222px;" name="pre_reason" id="pre_reason">
																					<option>업직종 전환</option>
																					<option>근무조건</option>
																					...
																					<option>학업</option>
																					<option>유학</option>
																					<option selected="selected">개인사정</option>
																					<option>기타</option>
																				</select>
																			<% } %>
																			<% if(calist.get(i).getPre_reason().equals("기타")){ %>
																				<select class="selectpicker"
																					style="width: 107.22222px; height: 50.22222px;" name="pre_reason" id="pre_reason">
																					<option>업직종 전환</option>
																					<option>근무조건</option>
											...
											<% } %>	
															...
															<div class="resume_row">
																...
																<% if(actlist.get(i).getAct_field().equals("동아리")){ %>
																	<select class="selectpicker"
																		...
																		<option value="서포터즈/기자단">서포터즈/기자단</option>
																		<option value="공모전">공모전</option>
																		<option value="동아리" selected="selected">동아리</option>
																		<option value="교내활동">교내활동</option>
																		<option value="자원봉사">자원봉사</option>
																		<option value="아르바이트">아르바이트</option>
																		<option value="사회활동">사회활동</option>
																...
																<% if(actlist.get(i).getAct_field().equals("교내활동")){ %>
																	<select class="selectpicker"
																		...
																		<option value="공모전">공모전</option>
																		<option value="동아리">동아리</option>
																		<option value="교내활동" selected="selected">교내활동</option>
																		<option value="자원봉사">자원봉사</option>
																		<option value="아르바이트">아르바이트</option>
																		<option value="사회활동">사회활동</option>
																		<option value="수행과제">수행과제</option>
																...
																<% if(actlist.get(i).getAct_field().equals("자원봉사")){ %>
																	<select class="selectpicker"
																		...
																		<option value="동아리">동아리</option>
																		<option value="교내활동">교내활동</option>
																		<option value="자원봉사" selected="selected">자원봉사</option>
																		<option value="아르바이트">아르바이트</option>
																		<option value="사회활동">사회활동</option>
																		<option value="수행과제">수행과제</option>
																		<option value="해외연수">해외연수</option>
																...
																<% if(actlist.get(i).getAct_field().equals("사회활동")){ %>
																	<select class="selectpicker"
																		...
																		<option value="자원봉사">자원봉사</option>
																		<option value="아르바이트">아르바이트</option>
																		<option value="사회활동" selected="selected">사회활동</option>
																		<option value="수행과제">수행과제</option>
																		<option value="해외연수">해외연수</option>
																		<option value="교육이수내역">교육이수내역</option>
																	</select>
																...
																<% if(actlist.get(i).getAct_field().equals("수행과제")){ %>
																	<select class="selectpicker"
																		...
																		<option value="아르바이트">아르바이트</option>
																		<option value="사회활동">사회활동</option>
																		<option value="수행과제" selected="selected">수행과제</option>
																		<option value="해외연수">해외연수</option>
																		<option value="교육이수내역">교육이수내역</option>
																	</select>
																<% } %>
																<% if(actlist.get(i).getAct_field().equals("해외연수")){ %>
																	<select class="selectpicker"
																		...
																		<option value="사회활동">사회활동</option>
																		<option value="수행과제">수행과제</option>
																		<option value="해외연수" selected="selected">해외연수</option>
																		<option value="교육이수내역">교육이수내역</option>
																	</select>
																<% } %>
																<% if(actlist.get(i).getAct_field().equals("교육이수내역")){ %>
																	<select class="selectpicker"
																		...
																		<option value="수행과제">수행과제</option>
																		<option value="해외연수">해외연수</option>
																		<option value="교육이수내역" selected="selected">교육이수내역</option>
																	</select>
																<% } %>
												...
												<div id="license" class="resume_section blind_guide"
													...
													<div class="resume_write resume_write_add">
														...
														<div id="tpl_row_1621990781" class="tpl_row"
															...
															<% for(int i=0; i< lanlist.size(); i++) { %>
															<div id="languagechk" style="display: block">
																<div class="resume_row">
																	...
																	<% if(lanlist.get(i).getLan_kind().equals("독일어")){ %>
																		<select class="selectpicker"
																			...
																			<option value="일본어">일본어</option>
																			<option value="중국어">중국어</option>
																			<option value="독일어" selected="selected">독일어</option>
																			<option value="불어">불어</option>
																			<option value="스페인어">스페인어</option>
																			<option value="러시아어">러시아어</option>
																			<option value="이탈리아어">이탈리아어</option>
																	...
																	<% if(lanlist.get(i).getLan_kind().equals("불어")){ %>
																		<select class="selectpicker"
																			...
																			<option value="중국어">중국어</option>
																			<option value="독일어">독일어</option>
																			<option value="불어" selected="selected">불어</option>
																			<option value="스페인어">스페인어</option>
																			<option value="러시아어">러시아어</option>
																			<option value="이탈리아어">이탈리아어</option>
																			<option value="한국어">한국어</option>
																	...
																	<% if(lanlist.get(i).getLan_kind().equals("스페인어")){ %>
																		<select class="selectpicker"
																			...
																			<option value="독일어">독일어</option>
																			<option value="불어">불어</option>
																			<option value="스페인어" selected="selected">스페인어</option>
																			<option value="러시아어">러시아어</option>
																			<option value="이탈리아어">이탈리아어</option>
																			<option value="한국어">한국어</option>
																			<option value="기타">기타</option>
																	...
																	<% if(lanlist.get(i).getLan_kind().equals("러시아어")){ %>
																		<select class="selectpicker"
																			...
																			<option value="불어">불어</option>
																			<option value="스페인어">스페인어</option>
																			<option value="러시아어" selected="selected">러시아어</option>
																			<option value="이탈리아어">이탈리아어</option>
																			<option value="한국어">한국어</option>
																			<option value="기타">기타</option>
																		</select>
																	...
																	<% if(lanlist.get(i).getLan_kind().equals("이탈리아어")){ %>
																		<select class="selectpicker"
																			...
																			<option value="스페인어">스페인어</option>
																			<option value="러시아어">러시아어</option>
																			<option value="이탈리아어" selected="selected">이탈리아어</option>
																			<option value="한국어">한국어</option>
																			<option value="기타">기타</option>
																		</select>
															...
															<% for(int i=0; i< awdlist.size(); i++) { %>
															<div id="awardchk" style="display: block">
												...
												<%-- <div id="attach_port_files" class="resume_section"
													...
													<div class="resume_write">
														...
														<div class="area_add_btn">
															<input type="text" name="filename2" value="<%=resumedto.getPortfolio() %>" size="50" readonly="readonly">
																...
																<div class="option option_area">
																	<div id="desire_apply_work_stat"
																		...
																		<input type="text" id="jobtypes" name="desiredjobtype"
																			value="<%=resumedto.getDesiredjobtype() %>" maxlength="50" class="box_input">
																		<div>
																			<ul>
																				<li class="menu"><a><img
															...
															<div class="option option_area">
																<div id="desire_area"
																	...
																	<input type="text" id="Areas" name="desiredarea1"
																		value="<%=resumedto.getDesiredarea1() %>" maxlength="50" class="box_input">
															...
															<div class="option option_area">
																<div id="desire_job_category"
																	...
																	<input type="text" id="Buses" name="desiredjob1"
																		value="<%=resumedto.getDesiredjob1() %>" maxlength="50" class="box_input">
														...
														<div id="tpl_row_1621990779" class="tpl_row"
																	...
																	<div class="resume_row">
																		...
																		<div class="sri_select resume_select">
																			<input type="hidden" name="pre_area" id="pre_area">
																			<select name="sido1" id="sido1"></select> 
																			<select name="gugun1" name="pre_area" id="gugun1" onchange="selectCareerArea()"></select>
...
<div id="tpl_row_1621990781" class="tpl_row"
															...
															<div class="resume_row">
																...
																<div class="sri_select resume_select">
																	<select class="selectpicker"
																		onchange="licenseCheck2(this.value);"
																		style="width: 107.22222px; height: 50.22222px;">
																		<option value="case1">자격증/면허증</option>
																		<option value="case2">어학시험</option>
																		<option value="case3">수상내역/공모전</option>
