...
<section id="contents">
	...
	<section class="board-view">
		<div class="tit-area">
			...
			<p class="date">${notice.regdate.substring(0,10) }</p>
		</div>
		
		<div class="info">
			<p class="tit">작성자</p>
			<p class="txt">${notice.memberid}</p>
		</div>
		...
		<div class="cont">
			<p>	
				...
				<c:if test="${notice.newfilename ne null}">	 	
					<img alt="" src ="./upload/${notice.newfilename}">
			    </c:if> 
			    ${notice.content}
						<!-- <img alt="" src="http://www.work.go.kr/framework/filedownload/richEditDownload.do?filePathName=L2F0dGFjaG1lbnQvbWFuYWdlci9yaWNoZWRpdC8yMDIxLzA1LzEwLzIwMjEwNTEwMTA0NjM2NTExLnBuZw==" border="0"><br> -->		
			</p>
		</div>
	</section>
...
<script>
var myVar;
function filedown(newfilename, noticeseq, filename) {
