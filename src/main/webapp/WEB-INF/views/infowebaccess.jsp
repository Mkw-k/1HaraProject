...
<section id="contents">
	...
	<div class="box-info bg-gray mb40">
		워크넷은 다양한 환경과 조건의 사용자가 불편함 없이 쉽게 편리하게 서비스를 이용할 수 있도록 웹 접근성 품질을 유지/강화하며, 장애인 고령자 등 
		정보취약계층을 위한 ‘한국형 웹 콘텐츠 접근성 지침 2.1’과 ‘전자정부서비스 호환성 준수지침(행정자치부 고시 제1호)”를 준수하고 있습니다. <br><br>

		워크넷 사이트 제작 시 웹 접근성 준수 여부를 점검하기 위해 웹 접근성 자동진단 도구인 HTML, CSS validator, K-WHA 4.0을 활용해 자동평가를하고 
		...
		워크넷은 국가표준에서 제시된 22개 검사 항목을 기반으로 제작되어, 장애인들이 사용하는 화면낭독 프로그램(Screen Reader)등 보조기기를 
		...
		워크넷은 웹 접근성 문제를 해결하기 위해 장애인 사용자, 웹 접근성 전문가들의 의견을 청하고, 웹 접근성 준수여부를 지속 점검토록 노력하겠습니
		다. 
	</div>
	...
	<div class="box-white">
		...
		<span class="font-blue2">워크넷은 웹 접근성 표준지침을 준수하여 품질마크를 부여 받았습니다.</span></p>
	</div>
