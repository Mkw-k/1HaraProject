			...
			<div class="row">
				...
				<div class="col-xl-12">
					<div class="single-price">
						...
						<form name="frmForm" id="_frmForm" action="updateAfFAQ.do" method="post" enctype="multipart/form-data">
							...
							<tr>
							    <th>질문</th>
							    <td style="text-align: left;">
							        <input type="text" name="question" size="100" value="${dto.question }">
							...
							<tr>
							    ...
							    <td style="text-align: left;">
							        <!-- 기존의 파일 -->
							        <%-- <input type="hidden" name="newnamefile" value="${dto.newfilename}"> --%>
							        <input type="text" name="namefile" value="${dto.filename}" size="50" readonly="readonly">
							        <!-- 수정할 파일 -->
							...
							<tr>
							    <th>답변</th>
							    <td style="text-align: left;">
							        <textarea rows="10" cols="100" name="faqanswer" class="content" >${dto.faqanswer }</textarea>
							    </td>
							</tr>
